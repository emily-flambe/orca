        ...
        <div className="flex items-center gap-2" ref={statusDropdownRef}>
          ...
          <div className="relative flex-1">
            <button
              ...
              className="flex items-center justify-between w-full px-2 py-2.5 md:py-1 text-xs bg-gray-800/60 border border-gray-700 rounded-md hover:border-gray-600 transition-colors text-gray-300 gap-1"
            >
            ...
            {statusDropdownOpen && (
              <div className="absolute top-full left-0 mt-1 z-50 bg-gray-900 border border-gray-700 rounded-lg shadow-xl py-1 min-w-full w-48">
                <div className="flex items-center justify-between px-3 py-2 md:py-1.5 border-b border-gray-800 mb-1">
                ...
                {STATUS_FILTERS.map((f) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-2 w-full px-3 py-2.5 md:py-1.5 text-xs hover:bg-gray-800 transition-colors"
                    >
                ...
                {allProjects.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1 px-2 py-1.5 md:py-0.5 text-xs rounded-full whitespace-nowrap transition-colors ${
                        active
          ...
          <div className="flex gap-1 overflow-x-auto scrollbar-none">
            {SORT_OPTIONS.map((s) => (
              <button
                key={s}
                onClick={() => setSort(s)}
                className={`px-2 py-2 md:py-0.5 text-xs rounded-full whitespace-nowrap transition-colors ${
                  sort === s

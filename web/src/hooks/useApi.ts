...
export function sendPromptToInvocation(id: number, prompt: string): Promise<{ ok: boolean; delivered: boolean }> {
  return fetchJson<{ ok: boolean; delivered: boolean }>(`/invocations/${id}/prompt`, {
    method: "POST",

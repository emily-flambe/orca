...
describe('parseRepoPath', () => {
  test('extracts repo path from description', () => {
    const desc = 'repo: C:\\Users\\emily\\Documents\\Github\\orca\n\nSome other text.';
    expect(parseRepoPath(desc)).toBe('C:\\Users\\emily\\Documents\\Github\\orca');
  });

  test('extracts repo path with extra whitespace', () => {
    expect(parseRepoPath('repo:   /home/user/project  ')).toBe('/home/user/project');
  });

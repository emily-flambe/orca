...
describe('closePr', () => {
  ...
  test('returns false and logs warning on failure', () => {
    ...
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining('closePr(#99) failed'));
  });
...
describe('closeOrphanedPrs', () => {
  ...
  test('skips PRs in runningBranches', () => {
    mockGhCalls([{ headRefName: 'orca/TASK-1-inv-1', number: 10, updatedAt: TWO_HOURS_AGO }]);
  ...
  test('skips PRs in activeBranches', () => {
    mockGhCalls([{ headRefName: 'orca/TASK-2-inv-1', number: 11, updatedAt: TWO_HOURS_AGO }]);
  ...
  test('skips PRs updated within maxAgeMs', () => {
    mockGhCalls([{ headRefName: 'orca/TASK-3-inv-1', number: 12, updatedAt: FIVE_MIN_AGO }]);
  ...
  test('PR with invalid updatedAt (NaN date) is skipped', () => {
    ...
    mockGhCalls([{ headRefName: 'orca/TASK-NAN', number: 300, updatedAt: 'not-a-date' }]);
  ...
  test('PR with empty updatedAt is skipped', () => {
    mockGhCalls([{ headRefName: 'orca/TASK-EMPTY', number: 301, updatedAt: '' }]);
  ...
  test('PR at exact maxAge boundary is NOT closed (age === maxAge, condition is <)', () => {
    ...
    mockGhCalls([{ headRefName: 'orca/TASK-BOUNDARY', number: 302, updatedAt: exactBoundary }]);
  ...
  test('PR 1ms younger than maxAge is skipped', () => {
    ...
    mockGhCalls([{ headRefName: 'orca/TASK-YOUNG', number: 303, updatedAt: justUnder }]);
  ...
  test('branch in both runningBranches AND activeBranches is still skipped', () => {
    mockGhCalls([{ headRefName: 'orca/TASK-BOTH', number: 400, updatedAt: TWO_HOURS_AGO }]);
  ...
  test('maxAgeMs of 0 closes all old orca PRs', () => {
    mockGhCalls([{ headRefName: 'orca/TASK-ZERO', number: 500, updatedAt: FIVE_MIN_AGO }]);
